...
func (f *TextFormatter) Format(entry *Entry) ([]byte, error) {
	...
	if f.isColored() {
		...
		f.printNotColored(b, entry, keys, data, timestampFormat)
	}
...
func (f *TextFormatter) printNotColored(b *bytes.Buffer, entry *Entry, keys []string, data Fields, timestampFormat string) {
